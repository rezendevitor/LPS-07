...
public class FrCadastroCliente extends javax.swing.JFrame {
    ...
    public FrCadastroCliente(ClienteController clienteController) throws ParseException {
        initComponents();
    ...
    private void initComponents() {
        ...
        grdUsuarios.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nome", "CPF", "Telefone", "E-mail", "Senha", "Sexo", "Data Nasc.", "Endereço"
            }
        ));
    ...
    public void formatarCampos(){
        try {
            ...
            Logger.getLogger(FrCadastroCliente.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public boolean validarCampos(){
        if(edtNome.getText().matches("{3,}") /*|| edtNome.getText().equals("")*/){
            ...
            if(!validarCPF(ftxCPF.getText())){
                ...
                ftxCPF.requestFocus();
                return false;
            }if(clienteController.existe(ftxCPF.getText()) == true && flagEdtSalvar == false){
    ...
    public void atualizarTabela(Object [] usr) {
        ArrayList<Object []> arrayObj = clienteController.buscarCliente(usr);
    ...
    public void update(){
        try {
            ...
            cliente[0] = edtNome.getText();
            cliente[1] = ftxCPF.getText();
            cliente[2] = ftxTelefone.getText();
            cliente[3] = edtEmail.getText();
            cliente[4] = senha;
            cliente[5] = cbxSexo.getSelectedItem().toString();
            cliente[6] = datasql;
            cliente[7] = edtEndereco.getText();
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        if(grdUsuarios.getSelectedRow() != -1){
            ...
            cliente[1] = cpf;
            cliente = clienteController.buscarCliente(cliente).get(0);
        }if(cliente != null){
            edtNome.setText(cliente[0].toString());
            ftxCPF.setText(cliente[1].toString());
            ftxTelefone.setText(cliente[2].toString());
            edtEmail.setText(cliente[3].toString());
            pswSenha.setText(cliente[4].toString());
            cbxSexo.setSelectedItem(cliente[5]);
            Date dataNasc = (Date) cliente[6];
            ftxDataNasc.setText(dataNasc.toString());
            edtEndereco.setText(cliente[7].toString());   
            this.habilitarBotoes(false, true, false, false, true, false, false, false);
            this.habilitarCampos(true);
            ...
            JOptionPane.showMessageDialog(rootPane, "Selecione um Cliente (clique na linha).");
        }
