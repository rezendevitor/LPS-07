...
public class FrCadastroAdmin extends javax.swing.JFrame {
    
    private boolean flagCancelar;
    private boolean flagEdtSalvar;
    AdministradorController adminController;
    private Object [] admin;
    private ArrayList<Object []> arrayAdmin = new ArrayList<>();
    
    public FrCadastroAdmin(AdministradorController adminController) throws ParseException {
        initComponents();
    ...
    public void formatarCampos(){
        try {
            ...
            Logger.getLogger(FrCadastroAdmin.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public boolean validarCampos(){
        if(edtNome.getText().matches("{3,}") /*|| edtNome.getText().equals("")*/){
            ...
            if(!validarCPF(ftxCPF.getText())){
                ...
                ftxCPF.requestFocus();
                return false;
            }if(adminController.existe(ftxCPF.getText()) == true && flagEdtSalvar == false){
    ...
    public void atualizarTabela(Object [] usr){       
        arrayAdmin = adminController.buscarAdmin(usr);
        DefaultTableModel dtm = (DefaultTableModel) grdUsuarios.getModel();
        dtm.setNumRows(0);
        for (int i=0; i<arrayAdmin.size(); i++) {
            dtm.addRow(new Object[]{
                arrayAdmin.get(i)[0], arrayAdmin.get(i)[1], arrayAdmin.get(i)[2], arrayAdmin.get(i)[3], arrayAdmin.get(i)[4], 
                arrayAdmin.get(i)[5], arrayAdmin.get(i)[6], arrayAdmin.get(i)[7]});
        }
    ...
    public void update(){
        try {
            ...
            admin[0] = edtNome.getText();
            admin[1] = ftxCPF.getText();
            admin[2] = ftxTelefone.getText();
            admin[3] = edtEmail.getText();
            admin[4] = senha;
            admin[5] = cbxSexo.getSelectedItem().toString();
            admin[6] = datasql;
            admin[7] = Float.parseFloat(edtSalario.getText());
            adminController.alterar(admin);
        } catch (ParseException ex) {
            Logger.getLogger(FrCadastroAdmin.class.getName()).log(Level.SEVERE, null, ex);
        }   
    }
        ...
        if(validarCampos()){
            if(this.flagEdtSalvar == true){
                ...
                try {
                    admin = new Object[8];   
                    SimpleDateFormat formatoData = new SimpleDateFormat("yyyy-MM-dd");
                    Date dataNasc = formatoData.parse(this.ftxDataNasc.getText());
                    java.sql.Date datasql = new java.sql.Date(dataNasc.getTime());
                    String senha = new String(pswSenha.getPassword());
                    admin[0] = edtNome.getText();
                    admin[1] = ftxCPF.getText();
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        if(grdUsuarios.getSelectedRow() != -1){
            ...
            admin[1] = cpf;
            admin = adminController.buscarAdmin(admin).get(0);
        }if(admin != null){
            edtNome.setText(admin[0].toString());
            ftxCPF.setText(admin[1].toString());
            ftxTelefone.setText(admin[2].toString());
            edtEmail.setText(admin[3].toString());
            pswSenha.setText(admin[4].toString());
            cbxSexo.setSelectedItem(admin[5]);
            Date dataNasc = (Date) admin[6];
            ftxDataNasc.setText(dataNasc.toString());
            edtSalario.setText(admin[7].toString());   
            this.habilitarBotoes(false, true, false, false, true, false, false, false);
            this.habilitarCampos(true);
            ...
            JOptionPane.showMessageDialog(rootPane, "Selecione um Administrador (clique na linha).");
        }
    ...
    private void btnConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsultarActionPerformed
        ...
        admin = new Object[8];
        admin[1] = cpf;
        adminController.buscarAdmin(admin);
        if(cpf.equals(null)){
            this.atualizarLog("Operação cancelada.");
        }else if(admin == null){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrCadastroAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
